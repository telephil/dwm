...
static const char *fonts[]          = { "Terminus:size=16", "TerminessTTF NF:size=18" };
...
static const char *muttcmd[] = { "st", "-t" ,"mutt", "-e" , "mutt", NULL };
static const char *vicmd[] = { "st", "-t", "vi", "-e", "vim", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_m,      spawn,          {.v = muttcmd } },
	{ MODKEY,                       XK_v,      spawn,          {.v = vicmd } },
